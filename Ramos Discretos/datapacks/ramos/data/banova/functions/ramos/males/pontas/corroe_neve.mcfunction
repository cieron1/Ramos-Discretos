execute positioned ~ ~1 ~ unless block ~ ~ ~ #banova:male_neve run tag @e[type=marker,tag=ale.1] add sem_lado
execute positioned ~ ~-1 ~ unless block ~ ~ ~ #banova:male_neve run tag @e[type=marker,tag=ale.2] add sem_lado
execute positioned ~1 ~ ~ unless block ~ ~ ~ #banova:male_neve run tag @e[type=marker,tag=ale.3] add sem_lado
execute positioned ~-1 ~ ~ unless block ~ ~ ~ #banova:male_neve run tag @e[type=marker,tag=ale.4] add sem_lado
execute positioned ~ ~ ~1 unless block ~ ~ ~ #banova:male_neve run tag @e[type=marker,tag=ale.5] add sem_lado
execute positioned ~ ~ ~-1 unless block ~ ~ ~ #banova:male_neve run tag @e[type=marker,tag=ale.6] add sem_lado
#
...
# +Y, -Y, +X, -X, +Z, -Z
execute if entity @e[type=marker,tag=ale.1-6,tag=ale.1,scores={Tempo=1..}] run place feature banova:male_neve ~ ~1 ~
execute if entity @e[type=marker,tag=ale.1-6,tag=ale.2,scores={Tempo=1..}] run place feature banova:male_neve ~ ~-1 ~
execute if entity @e[type=marker,tag=ale.1-6,tag=ale.3,scores={Tempo=1..}] run place feature banova:male_neve ~1 ~ ~
execute if entity @e[type=marker,tag=ale.1-6,tag=ale.4,scores={Tempo=1..}] run place feature banova:male_neve ~-1 ~ ~
execute if entity @e[type=marker,tag=ale.1-6,tag=ale.5,scores={Tempo=1..}] run place feature banova:male_neve ~ ~ ~1
execute if entity @e[type=marker,tag=ale.1-6,tag=ale.6,scores={Tempo=1..}] run place feature banova:male_neve ~ ~ ~-1
# Tp
...
#
execute at @s[scores={Pont.3=15..}] run function banova:ramos/males/pontas/bi_neve
#
