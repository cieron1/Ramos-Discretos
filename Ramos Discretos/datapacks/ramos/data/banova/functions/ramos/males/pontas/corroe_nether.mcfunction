...
# +Y, -Y, +X, -X, +Z, -Z
execute if entity @e[type=marker,tag=ale.1-6,tag=ale.1,scores={Tempo=1..}] run fill ~ ~1 ~ ~ ~1 ~ netherrack replace #banova:male_nether
execute if entity @e[type=marker,tag=ale.1-6,tag=ale.2,scores={Tempo=1..}] run fill ~ ~-1 ~ ~ ~-1 ~ netherrack replace #banova:male_nether
execute if entity @e[type=marker,tag=ale.1-6,tag=ale.3,scores={Tempo=1..}] run fill ~1 ~ ~ ~1 ~ ~ netherrack replace #banova:male_nether
execute if entity @e[type=marker,tag=ale.1-6,tag=ale.4,scores={Tempo=1..}] run fill ~-1 ~ ~ ~-1 ~ ~ netherrack replace #banova:male_nether
execute if entity @e[type=marker,tag=ale.1-6,tag=ale.5,scores={Tempo=1..}] run fill ~ ~ ~1 ~ ~ ~1 netherrack replace #banova:male_nether
execute if entity @e[type=marker,tag=ale.1-6,tag=ale.6,scores={Tempo=1..}] run fill ~ ~ ~-1 ~ ~ ~-1 netherrack replace #banova:male_nether
#
...
#
execute if entity @e[type=marker,tag=ale.1-6,tag=ale.1,scores={Tempo=1..}] run fill ~ ~1 ~ ~ ~1 ~ lava replace water
execute if entity @e[type=marker,tag=ale.1-6,tag=ale.2,scores={Tempo=1..}] run fill ~ ~-1 ~ ~ ~-1 ~ lava replace water
execute if entity @e[type=marker,tag=ale.1-6,tag=ale.3,scores={Tempo=1..}] run fill ~1 ~ ~ ~1 ~ ~ lava replace water
execute if entity @e[type=marker,tag=ale.1-6,tag=ale.4,scores={Tempo=1..}] run fill ~-1 ~ ~ ~-1 ~ ~ lava replace water
execute if entity @e[type=marker,tag=ale.1-6,tag=ale.5,scores={Tempo=1..}] run fill ~ ~ ~1 ~ ~ ~1 lava replace water
execute if entity @e[type=marker,tag=ale.1-6,tag=ale.6,scores={Tempo=1..}] run fill ~ ~ ~-1 ~ ~ ~-1 lava replace water
# Tp
...
#
execute at @s[scores={Pont.3=80..}] run function banova:ramos/males/pontas/bi_nether
#
